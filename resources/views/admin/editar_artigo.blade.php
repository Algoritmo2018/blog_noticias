 ...
 <!--fim error-->
    ...
    <div class="form-floating">
      ...
      <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" id="validationDefaultUsername" name="title"   aria-describedby="inputGroupPrepend2" value="{{$articles->title}}" required>
        </div>
      </div>
      <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
          ...
          <div class="form-floating mt-3"><textarea class="form-control mb-2" name="content" id="msg" style="height: 100px;"
            placeholder=" " cols="30" rows="10">{{$articles->content}}</textarea>
    ...
    <div class="col-md-12 mb-3">
      ...
      <div class="input-group">
        ...
        <input type="file" class="form-control" id="validationDefaultUsername" name="imagenew"   aria-describedby="inputGroupPrepend2" >
      </div>
    </div>
        </div>
